...
export async function POST(req) {
  try {
    ...
    await resend.emails.send({
      from: process.env.FROM_EMAIL || "info@thenextgensynergy.com",
      to: process.env.ADMIN_EMAIL || "info@thenextgensynergy.com",
    ...
    await resend.emails.send({
      ...
      subject: "Payment Initiated for NextGenSynergy Registration",
