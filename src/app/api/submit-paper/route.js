...
export async function POST(request) {
  try {
    ...
    const record = await pb.collection("NextGenSynergy_paper_form_submission").create(pbFormData)
    ...
    await resend.emails.send({
      from: "Conference <info@thenextgensynergy.com>",
      to: data.email,
      subject:
        "Paper Submission Confirmation - NextGen Synergy Conference 2025",
    ...
    await resend.emails.send({
      from: "Conference <info@thenextgensynergy.com>",
      to: "info@thenextgensynergy.com", // Replace with actual admin email
      subject: "New Paper Submission - NextGen Synergy Conference 2025",
