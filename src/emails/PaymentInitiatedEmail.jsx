      ...
      <head>
        ...
        <style>
          ...
          .section-title {
            ...
            font-weight: 600;
            margin-bottom: 15px;
            color: #ffffff; /* Changed from #a78bfa for better visibility */
          }
          ...
          .detail-label {
            color: #d1d5ff; /* Changed from #a5b4fc for better visibility */
            font-weight: 500;
          }
          ...
          .highlight {
            ...
            color: #ffffff; /* Added explicit text color for highlight content */
          }
          
          .highlight p {
            color: #ffffff; /* Ensuring paragraph text in highlights is white */
            margin: 0;
          }
          ...
          .card p, .card li {
            color: #e2e8f0; /* Lighter color for all paragraph text */
          }
      ...
      <body class="grid-pattern">
        <div class="container">
          ...
          <div class="footer">
            ...
            <p>For any questions, please contact <a href="mailto:info@thenextgensynergy.com" style="color: #38bdf8;">info@thenextgensynergy.com</a></p>
          </div>
        </div>
      </body>
    </html>
